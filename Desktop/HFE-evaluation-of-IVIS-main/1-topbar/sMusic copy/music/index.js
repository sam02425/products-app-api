var audioPlayer = function() {
    ...
    //   var player_containerX = _elements.progressBar.offsetLeft;
    //   var player_containerY = _elements.progressBar.offsetTop;
    ...
    //     coords.x = e.clientX - player_containerX;
    //     coords.y = e.clientY - player_containerY;
    ...
    var _setTrackTitle = function(currentTrack, playListRows) {
      ...
      var trackTitle = playListRows[currentTrack - 1].children[3].outerText;
    ...
    // Img
    var _setTrackImg = function(currentTrack, playListRows) {
      var trackImgBox = document.querySelector(".player .info-box .track-img");
      var trackImg = playListRows[currentTrack - 1].children[2].img;
  
      trackImgBox.img = null;
  
      trackImgBox.img = trackImg;
  
      document.track_img = trackImg;
    };
